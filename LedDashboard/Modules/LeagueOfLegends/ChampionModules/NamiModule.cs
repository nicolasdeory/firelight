    ...
    class NamiModule : ChampionModule
    {
        ...
        private void OnCastQ()
        {
            Task.Run(async () =>
            {
                ...
                _ = animator.RunAnimationOnce(ANIMATION_PATH + "Nami/q_cast.txt", timeScale: 0.8f);
            });
        ...
        private void OnCastW()
        {
            ...
            {
                await Task.Delay(150);
                _ = animator.RunAnimationOnce(ANIMATION_PATH + "Nami/w_cast.txt");
            });
        ...
        private void OnCastE()
        {
            ...
            {
                await Task.Delay(50);
                _ = animator.RunAnimationOnce(ANIMATION_PATH + "Nami/e_cast.txt", false, 0.15f);
            });
        ...
        private void OnCastR()
        {
            Task.Run(async () =>
            {
                _ = animator.RunAnimationOnce(ANIMATION_PATH + "Nami/r_launch.txt", timeScale: 0.7f);
            });
