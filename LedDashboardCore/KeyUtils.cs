...
namespace FirelightCore
{
    public class KeyUtils
    {
        ...
        private static int[,] pointToKeyArray = new int[6, 23]
        {
            ...
            {50,51,52,53,54,55,55,56,57,58,59,60,61,62,62,46,-1,-1,-1,100,101,102,99 },
            {63,64,65,66,67,68,69,69,70,71,72,73,74,-1,75,75,-1,76,-1,103,104,105,106 },
            {77,78,79,79,-1,80,80,80,80,-1,-1,81,82,83,83,84,85,86,87,107,107,108,106 }
        };

       /* private static int[,] numpadPointToKey = new int[6, 19]
        {
